...
function Login({ theme, setTheme }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Store user data in localStorage so all pages can access name and role
      // without needing to read cross-origin cookies
      if (data.user) {
      ...
      setTimeout(() => {
        // Redirect admins to admin dashboard, everyone else to dashboard
